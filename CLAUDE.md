...
* **El kit son 22 componentes** en `app/components/ui/`: acciones, campos, estado, prioridad, filtro, barra de filtros, panel, tabla, paginación, métrica navegable, árbol, aviso, diálogo, toast, breadcrumbs, grupo de navegación, pestañas, cabecera de página, búsqueda global, estado vacío, error en línea y etiqueta de ejemplar.
