 ...
 * implementación y no hace falta clase adaptadora (decisión 2 del design). `application`
 * inyecta siempre [SpeciesRepository], nunca este tipo.
 */
@Repository
interface JpaSpeciesRepository :
  SpeciesRepository,
  JpaRepository<Species, SpeciesId> {
  override fun findOneById(id: SpeciesId): Species?
  override fun findByScientificName(scientificName: String): Species?
}
