...
El sistema SHALL ofrecer el armazón de la aplicación: una barra lateral de navegación que marca la sección activa, una barra superior que aloja los breadcrumbs de la pantalla y un área de contenido con ancho máximo. En pantallas pequeñas la barra lateral SHALL convertirse en un panel lateral desplegable, oculto por defecto, con una acción de apertura y otra de cierre accesibles; al cerrarse SHALL devolver el foco a la acción que lo abrió.
